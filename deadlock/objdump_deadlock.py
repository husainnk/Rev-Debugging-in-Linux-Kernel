...
def getPthreadAddr():
    ...
    objDumpFile.close()
    print("pthread_mutex_lock " + hex(l_pthread_lock_addr))
    print("pthread_mutex_unlock " + hex(l_pthread_unlock_addr))
...
'''
    ...
    print(line)
    callqTarget = callqTargetAddr(line)
#    print(hex(callqTarget))
#    print(hex(g_pthread_lock_addr) + " " + hex(g_pthread_unlock_addr))
    if callqTarget != g_pthread_lock_addr and callqTarget != g_pthread_unlock_addr:
        continue 
#    print(hex(callqTarget))

    # Now pthread_lock/unlock called
    print(prev_line)
    prev_line = line
'''
